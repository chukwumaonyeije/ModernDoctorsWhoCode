---
audioUrl: /audio/ama-augmented-intelligence-physician-developer.mp3
author: Chukwuma Onyeije, MD, FACOG
authorUrl: https://www.linkedin.com/in/chukwumaonyeije
category: AI in Medicine
description: The AMA's 2026 survey shows 81% of physicians now use AI in practice.
  But read the fine print. Physicians want a seat at the table. The best way to earn
  that seat is to be the person who wrote the code.
draft: false
featured: true
image:
  alt: Physician at dual-monitor workstation with EHR on one screen and code on the
    other
...
title: The AMA Is Right About Augmented Intelligence — They're Wrong About Who Should
  Build It
---
...
If you are new here, I write from the perspective of [Chukwuma Onyeije, MD, FACOG](/about), a maternal-fetal medicine specialist in Atlanta and the physician-developer behind Doctors Who Code.
