...
description: "Ive recently started reading Why Machines Learn by Anil Ananthaswamy, a book that traces the elegant mathematics behind modern artificial intelligence...."
---

# _Reflections from reading Anil Ananthaswamy’s_ _**Why Machines Learn**_
...
I’ve recently started reading _Why Machines Learn_ by Anil Ananthaswamy, a book that traces the elegant mathematics behind modern artificial intelligence. As I work through the chapters, I want to practice “reading in public” — sharing insights while the ideas are still fresh, instead of waiting until I’ve finished the entire book.

![](https://doctorswhocode.blog/wp-content/uploads/2025/09/whymachineslearn.png)

Machine learning (ML) is everywhere: from voice assistants and recommendation engines to self-driving cars and medical imaging. Yet at its heart, it’s not magic — it’s mathematics. In this post, I’ll outline what machine learning actually _is_, drawing on the definitions and framing in Ananthaswamy’s book.
...
1. **Supervised Learning**
    ...
    - _Example:_ Predicting birth weight from ultrasound measurements.

3. **Unsupervised Learning**
    - Find hidden structure in unlabeled data.
    
    - _Example:_ Grouping patients with similar lab profiles into meaningful clusters.

5. **Reinforcement Learning**
    - Learn through trial and error, guided by rewards or penalties.
    
    - _Example:_ An insulin pump adjusting delivery based on blood glucose feedback.
...
In _Why Machines Learn_, Ananthaswamy shows how elegant math underlies this power. I’ll continue sharing reflections as I read, especially when we dive deeper into the mathematics that make ML possible.
