---
slug: from-fingersticks-to-the-future-how-cgm-is-transforming-gestational-diabetes-care
...
description: "At Atlanta Perinatal Associates, weve taken that message to heartand to code."
---

# **“The best time to innovate is before everyone else catches up.”**  

![](https://doctorswhocode.blog/wp-content/uploads/2025/07/chukwumaonyeije_From_Fingersticks_to_the_Future_How_CGM_is_Tr_1c836eba-8ddc-4242-9faf-1c64ef6de12b_0.png)
...
- **Traditional Medicaid:** via [Aeroflow](link-to-upload)
...
1. **Standardize Input:** Use CPT coding logic (`95249`–`95251`) to automate documentation templates.

3. **Track TIR Metrics:** Pull 63–140 mg/dL TIR into clinician dashboards for smart alerts or color-coded decision aids.

5. **Empower Patients:** Use Dexcom or Libre APIs for real-time data sharing, event annotation, and feedback loops.
...
- 📄 [CGM Protocol PDF (2025)](link-to-upload)

- 📋 [Aeroflow MD Referral Form](link-to-upload)

- 📘 [CGM 101 for Pregnancy](link-to-upload)

📬 **Questions?** Contact **Dr. Onyeije** at [Atlanta Perinatal Associates](https://atlantaperinatal.com/)


_Published: July 2025 | Doctors Who Code_
