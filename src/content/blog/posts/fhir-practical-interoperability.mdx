---
audioUrl: /audio/fhir-practical-interoperability.mp3
author: Chukwuma Onyeije, MD, FACOG
category: Practical Development
description: A step-by-step tutorial for physician-developers on authenticating with
  the Epic FHIR sandbox, making your first API call in Python, and building toward
  a SMART on FHIR clinical app -- no enterprise contract required.
featured: true
image:
  alt: Python code connecting to the Epic FHIR sandbox API, displayed on a dark terminal
    background
...
- "clinical-api"
- "healthcare-data"
title: 'The Physician-Developer''s FHIR Playbook: How to Pull Real Clinical Data from
  Epic Using Python'
---
...
If you are new here, I am [Chukwuma Onyeije, MD, FACOG](/about), a maternal-fetal medicine specialist in Atlanta and founder of Doctors Who Code.
