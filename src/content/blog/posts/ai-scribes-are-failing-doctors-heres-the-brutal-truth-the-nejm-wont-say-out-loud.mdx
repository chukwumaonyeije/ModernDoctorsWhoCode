---
audioUrl: /audio/ai-scribes-are-failing-doctors-heres-the-brutal-truth-the-nejm-wont-say-out-loud.mp3
author: Chukwuma Onyeije, MD, FACOG
category: Healthcare Technology
description: By Dr. Chukwuma Onyeije, MFM Specialist & Founder of CodeCraftMD
draft: false
image:
  alt: Physician looking frustrated at AI-generated clinical documentation on a computer
    screen
  url: /images/posts/ai-scribes-failing.jpeg
pubDate: 2025-11-28
tags:
- ai-medical-scribes
- ambient-ai
...
title: AI Scribes Are Failing Doctors—Here's the Brutal Truth the NEJM Won't Say Out
  Loud
---
...
_By Dr. Chukwuma Onyeije, MFM Specialist & Founder of CodeCraftMD_
...
Not per patient. _Per session._
...
- 71% physician adoption

- Nearly 100% patient consent

- ~22 minutes saved per day

- Significant burnout reduction
...
- Only 29-33% physician adoption

- 7-12 minutes saved per 18-patient session

- Control group also improved (suggesting external factors)
...
- Medical order entry: 15-20 minutes per patient

- Prior authorization requests: 20-30 minutes per case

- Lab and imaging review: 30-45 minutes daily

- Medical coding and billing: 10-15 minutes per encounter

- Patient message responses: 45-60 minutes daily

- Clinical loop closure: 20-30 minutes daily
...
_"True productivity gains will occur only when AI automates downstream tasks triggered by clinical documentation, not just the documentation itself."_

Translation: **We need workflow automation, not just documentation automation.**

Think about your last clinic day:

1. AI scribe captures the visit ✅

3. You manually enter orders ❌

5. You manually code the encounter ❌

7. You manually draft the prior auth ❌

9. You manually respond to follow-up messages ❌

11. You manually close clinical loops ❌
...
- Captures clinical conversation
...
- **Auto-drafts medical orders based on clinical plan**

- **Suggests accurate ICD-10 and CPT codes with documentation support**

- **Pre-populates prior authorization language**

- **Creates billing summaries**

- **Generates structured data for EHR import**

- **Triggers appropriate clinical follow-ups**
...
- Clinical note → accurate ICD-10/CPT codes with explanation

- Auto-generated billing summaries

- Prior authorization language extraction

- Structured documentation for EHR import
...
- **Cost:** $150-400 per physician per month

- **Time saved:** 7-22 minutes per day

- **ROI:** Unclear at scale

- **Adoption:** 29-71% physician uptake

- **Productivity impact:** Minimal to none
...
- Don't expect current AI scribes to give you your evenings back

- Understand what they _can_ do: reduce documentation burden and emotional exhaustion

- Demand workflow automation, not just documentation automation

**If you're a physician-developer:**

- The clinical workflow automation space is wide open

- Enterprise healthcare tech companies are moving too slowly

- Physician-led solutions will define the next decade

**If you're a healthcare administrator:**

- AI scribe ROI depends heavily on implementation quality

- True productivity requires downstream task automation

- Partner with physician-developers who understand clinical reality
...
- Integrate deeply with EHR workflows

- Automate downstream administrative tasks

- Generate accurate billing documentation

- Handle compliance requirements automatically

- Free physicians to practice at the top of their license
...
- Subscribe to Doctors Who Code for physician-developer insights

- Track CodeCraftMD development updates

- Join the community of clinicians building the future of healthcare technology
...
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/chukwumaonyeije/)
...
[NEJM AI Editorial](https://ai.nejm.org/doi/full/10.1056/AIe2501051) on Ambient AI Scribes and Physician Productivity (2025)

Shanafelt TD, et al. [Physician Burnout Rates](https://pubmed.ncbi.nlm.nih.gov/29505159/) and Contributing Factors

Afshar M, et al. University of Wisconsin [AI Scribe RCT](https://ai.nejm.org/doi/full/10.1056/AIoa2500945)

Lukac M, et al. UCLA [AI Scribe Implementation Study](https://www.uclahealth.org/news/release/ucla-study-finds-ai-scribes-may-reduce-documentation-time)


<FAQ items={[
  {
    question: "How much time do AI medical scribes actually save?",
    answer: "Two major RCTs showed 7-12 minutes saved per clinical session in real-world conditions (UCLA, 29-33% adoption). Best-case results under optimal implementation (University of Wisconsin) reached approximately 22 minutes per day. Both studies confirmed burnout reduction and improved patient satisfaction — but neither showed meaningful productivity gains."
  },
  {
    question: "Why are physicians still charting at 10 PM even with AI scribes?",
    answer: "Because AI scribes only automate one step in a multi-step administrative workflow: the progress note. After the note is written, physicians still manually enter orders, code the encounter, draft prior authorizations, respond to patient messages, and close clinical loops. One step automated out of six is not a productivity solution."
  },
  {
    question: "What is the difference between documentation automation and workflow automation?",
    answer: "Documentation automation — what current AI scribes provide — captures the clinical visit and generates a note. Workflow automation extends downstream: auto-drafting orders based on the clinical plan, generating accurate billing codes, pre-populating prior authorization language, creating billing summaries, and triggering appropriate follow-ups. The NEJM editorial concluded that true productivity gains require automating downstream tasks, not just the note."
  },
  {
    question: "Which AI scribe platforms were studied in the 2025 NEJM research?",
    answer: "The NEJM AI editorial analyzed RCTs covering three platforms: Abridge, Microsoft DAX Copilot, and Nabla. Physician adoption rates ranged from 29-71% depending on implementation quality, institutional support, and deployment context."
  },
  {
    question: "What is CodeCraftMD and how does it address the workflow automation gap?",
    answer: "CodeCraftMD is a clinical workflow automation platform built to handle the downstream tasks that AI scribes leave behind: accurate ICD-10 and CPT code generation, prior authorization language extraction, billing summaries, and structured documentation for EHR import. Where AI scribes generate the note, CodeCraftMD automates the administrative translation that follows it. It was built by an MFM specialist who experiences this gap daily."
  }
]} />

**Related Reading:**

- [The Bot Manager Fallacy in Healthcare AI](https://doctorswhocode.blog/the-bot-manager-fallacy-in-healthcare/)

- [Why Physicians Must Learn to Code](https://med.stanford.edu/news/insights/2020/03/why-being-a-programmer-will-make-me-a-better-doctor.html)

- [The Future of Medical Billing](https://codecraftmd.com/knowledge-hub/articles/ai-future-medical-billing.html)
