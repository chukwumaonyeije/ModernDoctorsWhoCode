...
1. Basic Machine Learning Principles
...
9. Healthcare-specific AI Applications
...
5. Howard, J., & Gugger, S. (2020). Deep Learning for Coders with fastai and PyTorch: AI Applications Without a PhD. O'Reilly Media.
...
9. Ranschaert, E. R., Morozov, S., & Algra, P. R. (2019). Artificial Intelligence in Medical Imaging: Opportunities, Applications and Risks. Springer.

11. Abràmoff, M. D., Lavin, P. T., Birch, M., Shah, N., & Folk, J. C. (2018). Pivotal trial of an autonomous AI-based diagnostic system for detection of diabetic retinopathy in primary care offices. NPJ Digital Medicine, 1(1), 1-8.

13. Jiang, F., Jiang, Y., Zhi, H., et al. (2017). Artificial intelligence in healthcare: past, present and future. Stroke and Vascular Neurology, 2(4), 230-243.

15. GitHub. (2024). Getting Started with GitHub for Healthcare AI Projects. GitHub Guides.
